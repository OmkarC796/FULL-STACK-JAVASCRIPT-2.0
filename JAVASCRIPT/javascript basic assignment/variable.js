...
console.log("Addition: " + myCalculator(num1, num2, "+"));
console.log("Substraction: " + myCalculator(num1, num2, "-"));
console.log("Multiplication: " + myCalculator(num1, num2, "*"));
console.log("Division: " + myCalculator(num1, num2, "/"));